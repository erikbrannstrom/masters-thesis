...
The properties defining targets and ads depend on the publisher. For example, ads on Facebook have an image, a body text, a title and a URL, and they use user characteristics such as age, gender, location or interests for targeting. Other publishers such as Google only use texts and no images, and also use different methods for targeting which is explained further in the end of this section.
